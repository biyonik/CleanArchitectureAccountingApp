...
namespace CleanArchitectureAccountingApp.Persistence.Migrations
{
    ...
    [Migration("20230120215916_Clear some identity tables")]
    partial class Clearsomeidentitytables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("CleanArchitectureAccountingApp.Domain.AppEntities.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("CleanArchitectureAccountingApp.Domain.AppEntities.Identity.AppUser", null)
                        .WithMany()
